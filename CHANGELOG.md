...
- `Response#status`, `Response#send`, `Response#json`, `Response#location`, and
`Response#redirect` added to `res` in `init()` middleware rather than being part
of base `Response` prototype.
